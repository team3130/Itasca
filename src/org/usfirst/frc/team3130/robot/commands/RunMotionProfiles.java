...
public class RunMotionProfiles extends Command {
	...
	public RunMotionProfiles(){
		...
		TrapezoidalTrajectory traj = new TrapezoidalTrajectory(24, 0, 0, 
    ...
    protected void initialize() {
    	...
    	Chassis.getFrontL().config_kP(0, 0.08, 0);
    	Chassis.getFrontR().config_kP(0, 0.08, 0);
    	Chassis.getFrontL().config_kI(0, 0.0, 0);
    	Chassis.getFrontR().config_kI(0, 0.0, 0);
