...
public class Rangefinder extends Subsystem {
    ...
    //code was copied from https://gist.github.com/anonymous/4aac6d39f0de0e0faac0
    private I2C i2c;
	...
	public int getDistance() {
		return (int)((Integer.toUnsignedLong(distance[0] << 8) + Byte.toUnsignedInt(distance[1])) / 2.54);
	}
